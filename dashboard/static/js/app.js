...
import { renderPortfolio } from './portfolio.js?v=6';
import { renderMarkets } from './markets.js?v=6';
import { renderTriptych } from './performance.js?v=6';
import { renderActivity } from './activity.js?v=6';
