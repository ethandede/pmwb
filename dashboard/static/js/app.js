...
import { renderPortfolio } from './portfolio.js?v=7';
import { renderMarkets } from './markets.js?v=7';
import { renderTriptych } from './performance.js?v=7';
import { renderActivity } from './activity.js?v=7';
